...
public final class RotationFactory {
    ...
    public @NotNull Rotation create(
        ...
        final float deltaYaw = previous == null ? 0F : AngleMath.normalizeDelta(normalizedYaw - previous.getYaw());
        final float deltaPitch = previous == null ? 0F : AngleMath.normalizeDelta(normalizedPitch - previous.getPitch());
